...
OldShader::OldShader(const std::string& shaderLocation, const GLenum& eShaderType) {
	Load(shaderLocation);
...
void OldShader::Load(const std::string& ShaderLocation) {
	bool complete = false;
	std::string line = "";
	std::string text = "";
...
void OldShader::Create(const GLenum& eShaderType, const std::string& strShaderFile){
