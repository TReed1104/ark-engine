...
private:
	...
	GLuint CompileShader(const std::string& strShaderFile, const GLenum& typeOfShader);
	bool CompileProgram(const std::string& vertexSourcePath, const std::string& fragmentSourcePath);
