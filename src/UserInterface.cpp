...
Model::Mesh UserInterface::GenerateMeshFromDimensions(const glm::vec2& dimensions) {
	...
	backgroundMesh.vertexPositions.push_back(glm::vec3(0.0f + dimensions.x, 0.0f, 0.0f));
	backgroundMesh.vertexPositions.push_back(glm::vec3(0.0f + dimensions.x, 0.0f + dimensions.y, 0.0f));
	backgroundMesh.vertexPositions.push_back(glm::vec3(0.0f, 0.0f + dimensions.y, 0.0f));
