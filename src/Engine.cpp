...
void Engine::LoadTextObjects(void) {
	...
	textObjectRegister.push_back(new TextObject("DEBUG: Font test", "Aa Bb Cc Dd Ee Ff Gg Hh Ii Jj Kk Ll Mm Nn Oo Pp Qq Rr Ss Tt Uu Vv Ww Xx Yy Zz .,'!?:;", fontRegister[indexOfFont], glm::vec3(20.0f, 50.0f, 0.02f), glm::vec3(255 / 255.0f, 0 / 255.0f, 0 / 255.0f), true));
